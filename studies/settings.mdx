...
| Custom pause URL | Where participants land when the study is paused or full. Must be `https://`, and supports `{param}` placeholders that pass through URL parameters — useful for panel-provider redirects. |
